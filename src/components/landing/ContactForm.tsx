...
const ContactForm = () => {
  ...
  return (
    <div ref={formRef} className="opacity-0 bg-white rounded-2xl p-8 shadow-xl border border-gray-100 max-w-md w-full mx-auto">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-tiercel-dark/70">
          Subscribe to receive our 10-Step Study Abroad Checklist and latest education tips.
        </p>
      </div>
